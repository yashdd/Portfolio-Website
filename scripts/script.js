...
function openModal(projectId) {
  ...
  const projects = {
    project1: {
      title: "PawPal",
      description: "PawPal is a web platform designed for pet owners and institutions to connect and manage pet-related activities seamlessly.",
      technologies: "HTML, CSS, JavaScript, Node.js",
      url: "https://github.com/yashdd/PawPal_Petcare_Website"
    },
    project2: {
      title: "Student Information Management System (SIMS)",
      description: "A web-based platform designed to streamline the management of student data and academic processes for educational institutions.",
      technologies: "HTML, CSS, JavaScript, PHP, MySQL",
      url: "https://www.kjsieit.in/sims/php/home.php"
    },
    project3: {
      title: "Social Media Engagement Analysis",
      description: "Analyzed social media engagement using Tableau, uncovering insights like demographic impacts and optimal posting schedules.",
      technologies: "Tableau, Data Visualization",
      url: "https://github.com/yashdd/SocialMediaCampaignEffectiveness/tree/main"
    },
    // Add all other project details similarly
  };
  ...
  modalContent.innerHTML = `
    ...
    <p>${project.description}</p>
    <p><strong>Technologies Used:</strong> ${project.technologies}</p>
    <a href="${project.url}" target="_blank">View Project on GitHub</a>
  `;
